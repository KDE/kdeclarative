...
ShaderEffect {
    ...
    vertexShader: Qt.resolvedUrl(":/qt/qml/org/kde/graphicaleffects/shaders/preserveaspect.vert.qsb")
    fragmentShader: Qt.resolvedUrl(":/qt/qml/org/kde/graphicaleffects/shaders/lanczos2sharp.frag.qsb")
}
